...
class ReservationCreateViewTest(APITestCase):
    ...
    def setUpTestData(cls):
        cls.user_donor = baker.make(
            User,
            type="donor",
            email="kenzinho1@email.com",
            password="123456",
            isAdm=True,
        )
        cls.user_donor.set_password(cls.user_donor.password)
        cls.user_donor.save()
        cls.user_charity = baker.make(
            User,
            type="charity",
    ...
    def test_create_reservation(self):
        ...
        data_donation = {
            "food": "amoras silvestres",
            "quantity": "10 caixas",
            "expiration": "2023-12-12",
            "classification_id": f"{self.classification.id}",
        }
        ...
        response_reservation = self.client.post(
            url_reservation, data_reservation, **headers
        )
